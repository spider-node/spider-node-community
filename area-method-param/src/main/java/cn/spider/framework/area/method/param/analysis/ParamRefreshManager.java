...
public class ParamRefreshManager {
    ...
    public ParamRefreshManager(NodeInterface nodeInterface, AreaInterface areaInterface) {
    ...
    public Future<Void> refreshMethod(String url, String classPath) {
        ...
        areaInterface.queryArea(queryAreaParam).onSuccess(areaSuss -> {
            ...
            try {
                //Map<String, NodeParamInfo> refreshAreaParam = analysisClass.buildParam(url, classPath);
