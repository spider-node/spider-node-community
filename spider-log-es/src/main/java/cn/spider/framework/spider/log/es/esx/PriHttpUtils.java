...
import cn.spider.framework.spider.log.es.esx.exception.RequestException;
import okhttp3.*;
...
class PriHttpUtils {
    ...
    public static PriHttpUtils http(String url,OkHttpClient okHttpClient) {
        OkHttpClient okHttpClients = Objects.nonNull(okHttpClient) ? okHttpClient : httpClientDefault;
        return new PriHttpUtils(url,okHttpClients);
    }
