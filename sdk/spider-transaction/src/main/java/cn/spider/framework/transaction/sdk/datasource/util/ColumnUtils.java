...
import cn.spider.framework.transaction.sdk.datasource.undo.KeywordChecker;
import cn.spider.framework.transaction.sdk.datasource.undo.KeywordCheckerFactory;
...
public final class ColumnUtils {
    ...
    public static String addEscape(String colName, String dbType) {
        if (isMysqlSeries(dbType)) {
            return addEscape(colName, dbType, Escape.MYSQL);
        }
        return addEscape(colName, dbType, Escape.STANDARD);
    }
