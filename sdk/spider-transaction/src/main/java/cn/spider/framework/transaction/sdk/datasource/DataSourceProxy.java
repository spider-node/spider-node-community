...
public class DataSourceProxy extends AbstractDataSourceProxy implements Resource {
     ...
     */
    private static boolean ENABLE_TABLE_META_CHECKER_ENABLE = true;

    /**
     * Table meta checker interval
     */
    private static final long TABLE_META_CHECKER_INTERVAL = 50;
    ...
    public DataSourceProxy(DataSource targetDataSource, String resourceGroupId) {
        if (targetDataSource instanceof SpiderDataSourceProxy) {
            LOGGER.info("Unwrap the target data source, because the type is: {}", targetDataSource.getClass().getName());
            targetDataSource = ((SpiderDataSourceProxy) targetDataSource).getTargetDataSource();
        }
