...
import static cn.spider.framework.transaction.sdk.core.model.BranchType.AT;
import static cn.spider.framework.transaction.sdk.core.model.BranchType.XA;
/**
...
public class RootContext {
    ...
    public static Long getBranchId() {
        return Long.parseLong((String) CONTEXT_HOLDER.get(BRANCH_ID)) ;
    }

    public static void bindBranchId(String batchId){
        if (StringUtils.isBlank(batchId)) {
            ...
            MDC.put(BRANCH_ID, batchId);
            if (LOGGER.isDebugEnabled()) {
                LOGGER.debug("bind {}", batchId);
            }
            CONTEXT_HOLDER.put(BRANCH_ID, batchId);
        }
    }
