...
import cn.spider.framework.transaction.sdk.datasource.exec.BaseInsertExecutor;
...
import cn.spider.framework.transaction.sdk.sqlparser.struct.SqlMethodExpr;
 ...
 * @author jsbxyyx
 */
@LoadLevel(name = JdbcConstants.MYSQL, scope = Scope.PROTOTYPE,order = 0)
