 ...
 *
 */
package cn.spider.framework.flow.exception;
...
public enum ExceptionEnum {
     ...
     * 流程实例中断
     */
    EXAMPLE_SUSPEND(ExceptionTypeEnum.ASYNC_TASK, "0005", "flow-example-suspend"),

    /**
     * 没有找到流程的startId
     */
    START_ID_NO_FIND(ExceptionTypeEnum.ASYNC_TASK, "0007", "start_id_no_find"),
