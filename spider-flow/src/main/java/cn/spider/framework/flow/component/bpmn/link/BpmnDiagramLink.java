...
import cn.spider.framework.flow.component.bpmn.joinpoint.EndJoinPoint;
...
public abstract class BpmnDiagramLink {
    ...
    private SequenceFlowImpl expressionSequenceFlow(String expression) {
        ...
        SequenceFlowExpression sequenceFlowExpression = new SequenceFlowExpression(expression,null,null,null,null,null);
