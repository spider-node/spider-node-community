...
public class TaskRunResultBackHandler {
    ...
    public void registerConsumer() {
        ...
        consumer.handler(message -> {
            ...
            // 修改每个节点的状态信息
            transactionManager.updateTransactionTaskStatus(data.getTransactionGroupId(), data.getFlowElementId(), status.equals(ElementStatus.SUSS) ? TaskStatus.SUCCESS : TaskStatus.FAIL,data.getRequestId());
        });
